...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-dokuwiki-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13228&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-dokuwiki-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-dokuwiki` can be installed with:

```
conda install python-dokuwiki
```

It is possible to list all of the versions of `python-dokuwiki` available on your platform with:
